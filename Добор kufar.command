...
#
# Шаг 0: собрать свежие объявления kufar (новые лиды → в конец базы).
...
#        Добор идёт «свежие первыми» — дневная квота уходит на новьё, остаток на хвост.
...
echo "════════════════════════════════════════════════════════"
echo "[$(date '+%F %T')] === шаг 0/3: сбор свежих объявлений kufar ===" | tee -a "$LOG"
./bin/python collect_realty.py --sources kufar 2>&1 | tail -5 | tee -a "$LOG"
